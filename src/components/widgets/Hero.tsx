        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-10 ">
          ...
          <div class="pt-6 md:py-20 lg:py-0 lg:flex lg:items-center lg:h-screen lg:gap-8">
            <div class="basis-1/2 text-center lg:text-left pb-8 md:pb-16 mx-auto">
              <a href="https://kas.fyi/token/krc20/WIENER" class="inline-flex justify-between items-center py-1 px-1 pr-3 mb-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                <span class="text-xs bg-primary-400 rounded-full text-white px-3.5 py-1.5 mr-2.5">New</span> <span class="text-sm font-medium">Free Website Audit & SEO Report!</span>
